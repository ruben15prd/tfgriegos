...
import com.ruben.connecttomysql.irrigation.severalTimesSchedule.SeveralTimesScheduleUtils;
    ...
    private class EditarSeveralTimesSchedule extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try{
                ...
                errores = SeveralTimesScheduleUtils.compruebaErrores(EditSeveralTimesDayScheduleActivity.this);
                if(errores.size()==0){
        ...
        protected void onPostExecute(Void result){
            ...
            if(errores.size()>0){
                ...
                Intent intent = new Intent (EditSeveralTimesDayScheduleActivity.this, ListSeveralTimesDayScheduleActivity.class);
